...
macx:ICON = src/qt/res/icons/heat.icns
macx:TARGET = "heat-Qt"

# Set libraries and includes at end, to use platform-defined defaults if not overridden
INCLUDEPATH += $$BOOST_INCLUDE_PATH $$BDB_INCLUDE_PATH $$OPENSSL_INCLUDE_PATH $$QRENCODE_INCLUDE_PATH C:\heat\heat-master\src C:\heat\heat-master\src\qt C:\Qt\4.8.6\include C:\Qt\4.8.6\include\QtGui
