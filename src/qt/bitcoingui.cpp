...
{
  resize(850, 550);
  setWindowTitle(tr("heat Wallet"));
#ifndef Q_WS_MAC
  setWindowIcon(QIcon(":icons/heat"));
#else
...
void BitcoinGUI::createActions()
{
  ...
  sendCoinsAction->setToolTip(tr("Send coins to a heat address"));
  sendCoinsAction->setCheckable(true);
  sendCoinsAction->setShortcut(QKeySequence(Qt::ALT + Qt::Key_2));
  tabGroup->addAction(sendCoinsAction);

  burnCoinsAction = new QAction(QIcon(":/icons/burn"), tr("&"BURN_COINS_DIALOG_NAME), this);
  burnCoinsAction->setToolTip(tr("Burn coins from a heat address"));
  ...
  aboutAction = new QAction(QIcon(":/icons/heat"), tr("&About %1").arg(qApp->applicationName()), this);
  aboutAction->setToolTip(tr("Show information about heat"));
  aboutAction->setMenuRole(QAction::AboutRole);
  aboutQtAction = new QAction(tr("About &Qt"), this);
  aboutQtAction->setToolTip(tr("Show information about Qt"));
  aboutQtAction->setMenuRole(QAction::AboutQtRole);
  optionsAction = new QAction(QIcon(":/icons/options"), tr("&Options..."), this);
  optionsAction->setToolTip(tr("Modify configuration options for heat"));
  optionsAction->setMenuRole(QAction::PreferencesRole);
  toggleHideAction = new QAction(QIcon(":/icons/heat"), tr("Show/Hide &heat"), this);
  toggleHideAction->setToolTip(tr("Show or hide the heat window"));
...
#ifndef Q_WS_MAC
      setWindowIcon(QIcon(":icons/heat_testnet"));
#else
      MacDockIconHandler::instance()->setIcon(QIcon(":icons/heat_testnet"));
#endif
      if(trayIcon)
      {
...
void BitcoinGUI::createTrayIcon()
{
  ...
  trayIcon->setToolTip(tr("heat client"));
  ...
  notificator = new Notificator(tr("heat-qt"), trayIcon);
}
...
void BitcoinGUI::setNumConnections(int count)
{
  ...
  labelConnectionsIcon->setToolTip(tr("%n active connection(s) to heat network", "", count));
}
